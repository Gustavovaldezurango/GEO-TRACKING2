                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" placeholder=" Nombre Conductor"
                                aria-label="Nombre Conductor" name="conductor" value="{{ old('conductor') }}">
                            @error('conductor')
                                <small>*{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="file" class="form-control" placeholder="Tecnico-Mecanica"
                                aria-label="Tecnico-Mecanica" name="tecnomecanica" value="{{ old('tecnomecanica') }}">
                            @error('tecnomecanica')
