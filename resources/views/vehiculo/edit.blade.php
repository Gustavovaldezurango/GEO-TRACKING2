...
@section('contenido')
    <form action="/vehiculos/{{ $vehiculo->id }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                <small>Nombre</small>
                <input type="text" class="form-control" placeholder=" Nombre Conductor" aria-label="Nombre Conductor"
                    name="conductor" value="{{ $vehiculo->conductor }}">
                @error('conductor')
                    <small>{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Documeto Conductor" aria-label="Documeto Conductor"
                    name="documentoconductor" value="{{ $vehiculo->documentoconductor }}">
        ...
        <div class="row">
            ...
            <div class="col">
                <small>Placa</small>
                <input type="text" class="form-control" placeholder="Placa" aria-label="Placa" name="placa"
        ...
        <div class="row">
            ...
            <div class="col">
                <small>Técnico-mecanica</small>
                <input type="file" class="form-control" placeholder="Tecnico-Mecanica" aria-label="Tecnico-Mecanica"
                    name="tecnomecanica" value="{{ $vehiculo->tecnomecanica }}">
                @error('tecnomecanica')
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="file" class="form-control" aria-label="Targeta de Propiedad" name="targetapropiedad"
                    value="{{ $vehiculo->targetapropiedad }}">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" placeholder="Fecha de Vencimiento"
                    aria-label="Fecha de Vencimiento" name="fechavencimiento" value="{{ $vehiculo->fechavencimiento }}">
