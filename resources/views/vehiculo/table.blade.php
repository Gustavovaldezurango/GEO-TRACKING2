    ...
    <tr>
        ...
        <td>
            <form action="{{ route('vehiculos.destroy',$vehiculo->id)}}"  method ="post">
                ...
                <a href="/vehiculos/{{$vehiculo->id}}/edit" class="btn btn-success  btn-sm"  data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><svg
                ...
                <a href={{ route('vehiculos.show',$vehiculo->id)}} class="btn btn-success  btn-sm" data-bs-toggle="tooltip"
